    ...
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-body deleteModal p-3 text-center">
         ...
         <input id="userNameID" type="text" class="form-control mb-4" placeholder="Name">
         <input id="userEmailID" type="text" class="form-control mb-4" placeholder="Email">
         <input id="userImgID" type="text" class="form-control mb-4" placeholder="Image Link">
         <input id="userMobID" type="text" class="form-control mb-4" placeholder="Mobile">
         <input id="userDetID" type="text" class="form-control mb-4" placeholder="Details">
    ...
    axios.post('/userDetails', {
        ...
        .then(function(response) {
            if (response.status == 200) {
                ...
                var jsonData = response.data;
                $('#userNameID').val(jsonData[0].name)
                $('#userEmailID').val(jsonData[0].email)
                $('#userMobID').val(jsonData[0].mobile)
                $('#userDetID').val(jsonData[0].des)
                $('#userImgID').val(jsonData[0].img)
